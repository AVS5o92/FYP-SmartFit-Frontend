  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to StyleAI. Let's build your wardrobe!",
      });
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-secondary via-primary to-accent">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Join StyleAI</h1>
          <p className="text-xl text-white/80 max-w-md">
            Create your account and let our AI stylist transform your wardrobe experience.
          </p>
        </div>
      </div>
